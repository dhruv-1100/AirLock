...
Threshold 0.55. 68 of 1000 benign items blocked.
...
- p_block **1.0** · tier `CACHE` · predicted `HEALTH_RECORD` · 491 chars
...
- p_block **0.7314** · tier `CACHE` · predicted `BENIGN` · 351 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 3. `wildchat:4b93f2ee31db290820c5408d061f796f` — WildChat-1M

- p_block **0.9982** · tier `CACHE` · predicted `PROPRIETARY_CODE` · 3129 chars
- evidence spans: `['access_token =', 'account_id =', 'insights.metric(impressions,engagement)']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 4. `cfpb:6150` — CFPB

- p_block **1.0** · tier `CACHE` · predicted `LEGAL_HR` · 1270 chars
...
## 5. `wildchat:2d523ca32a96b1d02e64e26ccb46b0bf` — WildChat-1M

- p_block **1.0** · tier `CACHE` · predicted `HEALTH_RECORD` · 460 chars
...
- p_block **0.9997** · tier `CACHE` · predicted `LEGAL_HR` · 815 chars
- evidence spans: `['My consumer report contains data that was obtained through identity theft']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 7. `cfpb:4066` — CFPB

- p_block **0.9866** · tier `CACHE` · predicted `FINANCIAL_NONPUBLIC` · 329 chars
- evidence spans: `['{$15000.00}']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 8. `wildchat:fb8b1efef359a99949b2e99ef86237c9` — WildChat-1M

- p_block **1.0** · tier `CACHE` · predicted `HEALTH_RECORD` · 476 chars
...
- p_block **1.0** · tier `CACHE` · predicted `BENIGN` · 560 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 10. `cfpb:839` — CFPB

- p_block **0.9997** · tier `CACHE` · predicted `LEGAL_HR` · 1821 chars
...
- p_block **0.8936** · tier `CACHE` · predicted `BENIGN` · 456 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 12. `wildchat:a07842b1a28cca9853c88c480edcbfd8` — WildChat-1M

- p_block **0.9136** · tier `CACHE` · predicted `BENIGN` · 725 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 13. `cfpb:4428` — CFPB

- p_block **0.6901** · tier `CACHE` · predicted `LEGAL_HR` · 680 chars
- evidence spans: `['15 U.S.C. 1681n']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 14. `cfpb:728` — CFPB

- p_block **0.9999** · tier `CACHE` · predicted `FINANCIAL_NONPUBLIC` · 1953 chars
- evidence spans: `['Account No. XXXX', 'XXXX XXXXXXXX XXXX XXXXXXXX', '{$630.00}']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 15. `cfpb:6668` — CFPB

- p_block **0.9999** · tier `CACHE` · predicted `FINANCIAL_NONPUBLIC` · 1359 chars
...
- p_block **1.0** · tier `CACHE` · predicted `LEGAL_HR` · 2692 chars
...
- p_block **0.9859** · tier `CACHE` · predicted `BENIGN` · 1427 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 18. `wildchat:082c3553c3c0a583ddb2e6e96bb64213` — WildChat-1M

- p_block **1.0** · tier `CACHE` · predicted `HEALTH_RECORD` · 706 chars
- evidence spans: `['Patricia Hertig has been suffering from several conditions, which were exacerbated by her recent accident']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 19. `cfpb:6673` — CFPB

- p_block **0.9369** · tier `CACHE` · predicted `LEGAL_HR` · 1927 chars
- evidence spans: `['Aldous and Associates', '$130.00']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 20. `cfpb:5717` — CFPB

- p_block **0.9986** · tier `CACHE` · predicted `PAYMENT_CARD` · 1699 chars
- evidence spans: `['XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX', '15 USC 1666b', '15 USC 1666b ( a ) Time to make payments']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 21. `wildchat:59cab2ce7ac675e1ddf21eebfcefc0da` — WildChat-1M

- p_block **0.9991** · tier `CACHE` · predicted `BENIGN` · 2888 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 22. `cfpb:3512` — CFPB

- p_block **0.9999** · tier `CACHE` · predicted `PAYMENT_CARD` · 487 chars
- evidence spans: `['XXXX XXXX XXXX Balance Owed : {$0.00} XXXX XXXX XXXX XXXXXXXX Balance Owed : {$0.00}']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 23. `cfpb:528` — CFPB

- p_block **0.9868** · tier `CACHE` · predicted `GOV_ID` · 2653 chars
...
- p_block **0.9999** · tier `CACHE` · predicted `LEGAL_HR` · 2189 chars
...
- p_block **1.0** · tier `CACHE` · predicted `LEGAL_HR` · 1334 chars
...
- p_block **1.0** · tier `CACHE` · predicted `BENIGN` · 1497 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 27. `cfpb:2855` — CFPB

- p_block **1.0** · tier `CACHE` · predicted `BENIGN` · 3318 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 28. `wildchat:f90779e2f5e81b513138558537002b8b` — WildChat-1M

- p_block **0.9981** · tier `CACHE` · predicted `BENIGN` · 2209 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 29. `wildchat:d4a129a5df04e9a85e7e96e59c19276c` — WildChat-1M

- p_block **1.0** · tier `CACHE` · predicted `HEALTH_RECORD` · 436 chars
- evidence spans: `['drooling, muscle spasms and incontinence']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 30. `cfpb:3542` — CFPB

- p_block **0.9928** · tier `CACHE` · predicted `PAYMENT_CARD` · 784 chars
- evidence spans: `['XXXX XXXX XXXX', 'Last for digits of ss # is XXXX']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 31. `cfpb:248` — CFPB

- p_block **0.998** · tier `CACHE` · predicted `LEGAL_HR` · 1373 chars
- evidence spans: `['26 U.S. Code 1099-C', 'IRS Form 1099-C', '{$600.00}']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 32. `cfpb:5817` — CFPB

- p_block **0.9998** · tier `CACHE` · predicted `GOV_ID` · 1207 chars
...
- p_block **1.0** · tier `CACHE` · predicted `LEGAL_HR` · 3404 chars
- evidence spans: `['CFPB', 'Fair Credit Reporting Act ( FCRA )', 'Fair Debt Collections Practices Act ( FDCPA )']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 34. `cfpb:6792` — CFPB

- p_block **0.9796** · tier `CACHE` · predicted `LEGAL_HR` · 1402 chars
...
- p_block **1.0** · tier `CACHE` · predicted `FINANCIAL_NONPUBLIC` · 3502 chars
- evidence spans: `['XXXX Police Identity Theft Report, FTC ID Theft Report']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 36. `cfpb:1174` — CFPB

- p_block **0.9998** · tier `CACHE` · predicted `GOV_ID` · 1799 chars
- evidence spans: `['Consumer Social Security Number : ( XXXX )', 'Consumer Date of Birth : ( XX/XX/XXXX )', 'Consumer Name : XXXX XXXX']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 37. `cfpb:6129` — CFPB

- p_block **0.9992** · tier `CACHE` · predicted `PAYMENT_CARD` · 954 chars
- evidence spans: `['$29000.00', '$36000.00', '$9600.00']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 38. `cfpb:3714` — CFPB

- p_block **0.9709** · tier `CACHE` · predicted `PAYMENT_CARD` · 747 chars
...
## 39. `wildchat:e850a3673c27423f2c07c226fc8423bf` — WildChat-1M

- p_block **0.9932** · tier `CACHE` · predicted `PROPRIETARY_CODE` · 682 chars
- evidence spans: `['nazi schoolgirl']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 40. `cfpb:3224` — CFPB

- p_block **1.0** · tier `CACHE` · predicted `PAYMENT_CARD` · 1460 chars
- evidence spans: `['XXXX XXXX XXXX XXXX XXXX', 'TX XXXX']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 41. `wildchat:b34043702435fac520b51376130b27b1` — WildChat-1M

- p_block **0.9675** · tier `CACHE` · predicted `PROPRIETARY_CODE` · 746 chars
- evidence spans: `['c:/Users/mozit/cookies.json', 'wss://sydney.bing.com/sydney/ChatHub']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 42. `cfpb:1772` — CFPB

- p_block **1.0** · tier `CACHE` · predicted `LEGAL_HR` · 1697 chars
...
- p_block **0.9981** · tier `CACHE` · predicted `GOV_ID` · 1619 chars
- evidence spans: `['EQUIFAX XXXX XXXX', '15 USC 1666b', '15 USC 1666b ( a )']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 44. `cfpb:3935` — CFPB

- p_block **0.998** · tier `CACHE` · predicted `GOV_ID` · 898 chars
- evidence spans: `['XXXX XXXX, XXXX, XX/XX/year>', 'CFPB complaint', 'FCRA 605B']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 45. `cfpb:6210` — CFPB

- p_block **0.9867** · tier `CACHE` · predicted `LEGAL_HR` · 2820 chars
...
## 46. `wildchat:ab966e886a801f4c45603586704ecaea` — WildChat-1M

- p_block **0.9609** · tier `CACHE` · predicted `BENIGN` · 663 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 47. `wildchat:4bf54b9d4f14cbbf8d2dbace13d2e4d8` — WildChat-1M

- p_block **0.9941** · tier `CACHE` · predicted `LEGAL_HR` · 981 chars
- evidence spans: `['Company Act 2063']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 48. `cfpb:4851` — CFPB

- p_block **0.9989** · tier `CACHE` · predicted `LEGAL_HR` · 349 chars
- evidence spans: `['XXXX XXXX']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 49. `wildchat:72addbf5f4febc6b68d7156a0d17b8b2` — WildChat-1M

- p_block **0.9526** · tier `CACHE` · predicted `BENIGN` · 3830 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 50. `cfpb:418` — CFPB

- p_block **1.0** · tier `CACHE` · predicted `GOV_ID` · 2698 chars
...
## 51. `wildchat:7a05aa4eed5efc56af1f459205a7c05e` — WildChat-1M

- p_block **1.0** · tier `CACHE` · predicted `PROPRIETARY_CODE` · 2338 chars
- evidence spans: `['namespace TextFileProcessor', 'using System;', 'using System.Collections.Generic;']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 52. `wildchat:eefe96cb176fcc3fce4233b9a8018eb9` — WildChat-1M

- p_block **0.852** · tier `CACHE` · predicted `BENIGN` · 3727 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 53. `cfpb:5079` — CFPB

- p_block **0.8963** · tier `CACHE` · predicted `PAYMENT_CARD` · 1860 chars
- evidence spans: `['XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 54. `cfpb:7126` — CFPB

- p_block **0.9886** · tier `CACHE` · predicted `GOV_ID` · 2817 chars
...
## 59. `wildchat:cfde1388929d00987e5b790cc0c687c9` — WildChat-1M

- p_block **0.9968** · tier `CACHE` · predicted `BENIGN` · 1998 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 60. `cfpb:5908` — CFPB

- p_block **0.9997** · tier `CACHE` · predicted `FINANCIAL_NONPUBLIC` · 1568 chars
- evidence spans: `['{$26000.00}', '{$5300.00}', '{$10000.00}']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 61. `cfpb:4212` — CFPB

- p_block **1.0** · tier `CACHE` · predicted `LEGAL_HR` · 981 chars
...
## 62. `wildchat:d17d67ced7b5b3c6297943c0471f916b` — WildChat-1M

- p_block **0.9999** · tier `CACHE` · predicted `CREDENTIAL` · 3358 chars
...
## 63. `wildchat:7722c68dbf007f85be9487938b48969c` — WildChat-1M

- p_block **0.9998** · tier `CACHE` · predicted `CREDENTIAL` · 903 chars
- evidence spans: `['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']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 64. `cfpb:1415` — CFPB

- p_block **0.9996** · tier `CACHE` · predicted `GOV_ID` · 1278 chars
- evidence spans: `['XXXXXXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXX XXXXXXXX', 'TX XXXX XXXX XXXX XXXX XXXX XXXX XXXX']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 65. `wildchat:522b559399816aa9ffce9db579dd47ab` — WildChat-1M

- p_block **0.9999** · tier `CACHE` · predicted `BENIGN` · 1430 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 66. `wildchat:17b99b14bd2f0c6675a841fc08b77caf` — WildChat-1M

- p_block **0.9933** · tier `CACHE` · predicted `BENIGN` · 3137 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 67. `wildchat:9df5c7d054acec3d29ac9a9e61a707fc` — WildChat-1M

- p_block **0.9999** · tier `CACHE` · predicted `BENIGN` · 2718 chars
- evidence spans: `[]`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_

## 68. `wildchat:f3f1790cb820404ec3f680121bde1006` — WildChat-1M

- p_block **1.0** · tier `T2` · predicted `HEALTH_RECORD` · 2549 chars
- evidence spans: `['0.052.6/0.019= 16.52mg/dl', '0.079/0.021*200=752.38mg/dl', '0.081/0.199=0.4mmol de H2O/min']`
- **Adjudication:** _(genuine FP / corpus contamination / borderline)_
